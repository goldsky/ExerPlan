ExerPlan.grid.Levels = function(config) {
    config = config || {};

    Ext.applyIf(config, {
        id: 'exerplan-grid-levels',
    ...
    ExerPlan.grid.Levels.superclass.constructor.call(this, config);
};

Ext.extend(ExerPlan.grid.Levels, MODx.grid.Grid, {
    getMenu: function() {
        return [{
...
Ext.reg('exerplan-grid-levels', ExerPlan.grid.Levels);

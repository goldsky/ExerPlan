...
class GalleryMediatypesUpdateProcessor extends modObjectUpdateProcessor {

    public $classKey = 'GalleryMediatypes';
    public $languageTopics = array('exerplan:cmp');
    public $objectType = 'exerplan.GalleryMediatypesUpdate';

}

return 'GalleryMediatypesUpdateProcessor';
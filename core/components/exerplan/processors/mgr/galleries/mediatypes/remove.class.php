...
class GalleryMediatypesRemoveProcessor extends modObjectRemoveProcessor {

    public $classKey = 'GalleryMediatypes';
    public $languageTopics = array('exerplan:cmp');
    public $objectType = 'exerplan.GalleryMediatypesRemove';

}

return 'GalleryMediatypesRemoveProcessor';
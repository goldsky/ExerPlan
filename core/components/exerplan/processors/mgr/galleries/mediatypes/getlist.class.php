...
class GalleryMediatypesGetListProccessor extends modObjectGetListProcessor {

    public $classKey = 'GalleryMediatypes';
    public $languageTopics = array('exerplan:cmp');
    public $defaultSortField = 'id';
    public $defaultSortDirection = 'ASC';
    public $objectType = 'exerplan.GalleryMediatypesGetList';

}

return 'GalleryMediatypesGetListProccessor';
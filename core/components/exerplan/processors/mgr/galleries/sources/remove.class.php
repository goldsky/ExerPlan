...
class GallerySourcesRemoveProcessor extends modObjectRemoveProcessor {

    public $classKey = 'GallerySources';
    public $languageTopics = array('exerplan:cmp');
    public $objectType = 'exerplan.GallerySourcesRemove';

}

return 'GallerySourcesRemoveProcessor';
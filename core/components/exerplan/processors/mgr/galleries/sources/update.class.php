...
class GallerySourcesUpdateProcessor extends modObjectUpdateProcessor {

    public $classKey = 'GallerySources';
    public $languageTopics = array('exerplan:cmp');
    public $objectType = 'exerplan.GallerySourcesUpdate';

}

return 'GallerySourcesUpdateProcessor';